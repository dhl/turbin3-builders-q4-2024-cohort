...
/// Configures the conditional Registrar,
...
pub struct ConfigureRegistrar<'info> {
    /// The conditional Plugin Registrar to be updated
    #[account(mut)]
    ...
    #[account(
        address = registrar.realm @ ConditionalPluginError::InvalidRealmForRegistrar,
